...
export const BentoGridItem = ({
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('egehankrkmz@gmail.com');
        setCopied(true);
    }
        ...
        <div className={`${id === 6 && "flex justify-center"} h-full`}>
            ...
            {id === 3 && (
                <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
                    <div className="flex flex-col gap-3 lg:gap-8">
                        {
                            ...
                            <span key={item} className="py-2 lg:py-4lg:px-3 
                            px-3 texts-xs lg:text-base opacity-50 lg:opacity-100
                    ...
                    <span className="py-4 px-3 rounded-lg text-center bg-[#10132E]"></span>
                        {
                            ['bootstrap', 'C / C++', 'Vite', 'SQL'].map((item) => (
                            <span key={item} className="py-2 lg:py-4lg:px-3 
                            px-3 texts-xs lg:text-base opacity-50 lg:opacity-100
                            rounded-lg text-center bg-[#10132E]">
                                {item}
